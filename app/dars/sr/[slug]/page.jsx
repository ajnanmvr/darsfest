        ...
        <div className="flex h-48 items-end mb-8 w-[1260px]">
          ...
          <div className="">
            <div className="flex whitespace-nowrap font-semibold">
              ...
              <p className="w-6 print:w-5 -rotate-90">ക്ലാസ് അവതരണം </p>
              <p className="w-6 print:w-5 -rotate-90">വഅ്ള് </p>
              ...
              <p className="w-6 print:w-5 -rotate-90">ഖുഥ്ബ </p>
              <p className="w-6 print:w-5 -rotate-90">ഗ്രന്ഥ വായന </p>
              <p className="w-6 print:w-5 -rotate-90">കവിതാലാപനം മലയാളം </p>
              <p className="w-6 print:w-5 -rotate-90">മുശാഅറ </p>
              <p className="w-6 print:w-5 -rotate-90">അനൗണ്‍സ്മെന്‍റ് </p>
              <p className="w-6 print:w-5 -rotate-90">പ്രബന്ധാവതരണം </p>
              <p className="w-6 print:w-5 -rotate-90">നിമിഷപ്രസംഗം </p>
              <p className="w-6 print:w-5 -rotate-90">പാടിപ്പറയല്‍ </p>
              <p className="w-6 print:w-5 -rotate-90">
                മാഷപ്പ് മാപ്പിളപ്പാട്ട്
              </p>
              <p className="w-6 print:w-5 -rotate-90">ഖസ്വീദ പാരായണം </p>
              <p className="w-6 print:w-5 -rotate-90">പ്രോഗ്രാം സെറ്റിംഗ് </p>
              <p className="w-6 print:w-5 -rotate-90">അറബിക് കാലിഗ്രഫി </p>
              ...
              <p className="w-6 print:w-5 -rotate-90">പത്രനിര്‍മാണം</p>
            </div>
          </div>
        </div>
      </div>
